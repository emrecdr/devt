...
name: tdd-patterns
description: >-
  Enforces test-driven development — failing test BEFORE production code, then RED-GREEN-REFACTOR cycle
  with mandatory verification gates. Use when the user says "TDD this", "test first", "write the failing
  test before the code", "test-driven", or "red-green-refactor". Distinct from debugging existing failing
