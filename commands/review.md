---
name: review
description: Standalone code review — READ-ONLY analysis. --focus routes to specialized reviews (architecture, quality gates).
argument-hint: "[--focus=code|arch|quality] [--lite|--full] [--range=<a>..<b>]"
---
