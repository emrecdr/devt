...
<process>
**Mandatory first action**: read `${CLAUDE_PLUGIN_ROOT}/workflows/quick-implement.md` via the Read tool before any other action. The workflow body is NOT preloaded — the explicit Read is the only load path.
