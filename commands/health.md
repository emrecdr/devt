---
name: health
description: Diagnose devt plugin health — checks .devt-state/ integrity, .dev-rules/ completeness, config validation, and hook status. Use when workflows fail unexpectedly or after interrupted sessions.
---
