...
4. **STOP: no codebase** — If .dev-rules/ is missing and no codebase context is available, warn the user and proceed with generic questions
</deviation_rules>
...
- Read `.dev-rules/coding-standards.md` for naming/patterns
- Read `.dev-rules/architecture.md` for project structure
...
Claude: [Reads .dev-rules/, analyzes codebase]
