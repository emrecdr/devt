...
- [ ] E001: .devt.json exists (or defaults are sufficient)
- [ ] E002: .dev-rules/ directory exists
- [ ] E003: Required .dev-rules/ files present (coding-standards.md, testing-patterns.md, quality-gates.md)
- [ ] W001: .dev-rules/architecture.md exists (recommended)
- [ ] W002: .dev-rules/documentation.md exists (recommended)
