...
# npx eslint .
# golangci-lint run ./...
echo "WARN: Linting gate not configured. Edit .dev-rules/quality-gates.md"
```
...
# npx tsc --noEmit
# go vet ./...
echo "WARN: Type checking gate not configured. Edit .dev-rules/quality-gates.md"
```
...
# npx jest --coverage
# go test ./...
echo "WARN: Test gate not configured. Edit .dev-rules/quality-gates.md"
```
