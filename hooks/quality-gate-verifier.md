...
workflow. If one is found it reads `.devt/rules/quality-gates.md` and executes
    ...
    "Stop": [
      {
        ...
        "instructions": "Check if .devt/state/workflow.yaml shows active workflow. If active, read .devt/rules/quality-gates.md and run the commands. If any fail, return: {\"decision\": \"block\", \"reason\": \"Quality gate failed: <details>\"}. If all pass or no active workflow, return: {\"decision\": \"allow\"}"
      }
    ]
  }
}
