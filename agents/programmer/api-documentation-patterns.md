...
Standards for documenting APIs within the codebase. These are generic guidelines — read `.devt/rules/` for project-specific conventions and framework details.
...
- **Read `.devt/rules/documentation.md`** for project-specific formatting, file naming, and structural rules
